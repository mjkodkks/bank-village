...
<template>
  <div class="h-[calc(100dvh_-_50px)] overflow-auto px-2 md:px-6 xl:px-8 py-8">
    ...
    <h3 class="font-light text-center m-0">
      ธนาคารหมู่บ้านตามแนวพระราชดำริ (สาขา บ้านกุดโดน)
    </h3>
    <h1>สถิติ (stat)</h1>
    ...
    <div class="flex justify-center mt-8">
      <Button size="large" icon="pi pi-chevron-right" label="เริ่มใช้งานระบบ" @click="router.push('member')" />
    </div>
  </div>
</template>
